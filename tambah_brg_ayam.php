...
{	
    $jumlah_ayam = $_POST['jumlah_ayam'];
        ...
        // include database connection file
        include_once("koneksi.php");
        $sql = "INSERT INTO brg_ayam(jumlah_ayam) VALUES('$jumlah_ayam')";
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-warning sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <div class="text-center d-none d-md-inline">
                ...
                ?>
                <form action="tambah_brg_ayam.php" method="POST" name="update_ayam"> 
                    <div class="form-group">
                        <label for="" class="col-form-label">Total Ayam</label>
                        <input type="text" class="form-control" name="jumlah_ayam" ></input>
                    </div>
                    <div class="form-group">
